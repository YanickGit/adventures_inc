...
?>
    ...
    <p class="text-center">
        ...
        <a onclick="return confirm('NOTICE: You are about to PERMANENTLY DELETE <?php echo strtoupper($result['firstname'])?> <?php echo strtoupper($result['lastname']) ?>\'S RECORD, are you sure?');" href ="action-delete-a-client-hard.php?client_id=<?php echo $result['client_id'] ?>" class ="btn btn-dark">Purge...</a>
    </p> 
    </div>
    </div>
    </div>
