  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a onclick="return confirm('NOTICE: You are about to PERMANENTLY DELETE <?php echo strtoupper($row['firstname'])?> <?php echo strtoupper($row['lastname']) ?>\'S RECORD, are you sure?');" href ="action-delete-a-client-hard.php?client_id=<?php echo $row['client_id'] ?>" class ="btn btn-dark">Purge...</a>
      </td>
    </tr>
    <?php } ?>
  </tbody> 
